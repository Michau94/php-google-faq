<?php $faqs = [
    ...
    [
        'title' => "<h2 class='SbNcad'>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>",
        'text' => [
